...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    // for implementing login functionality here
    // for accessing emailOrUsername and password states here
    console.log('Login clicked with email/username:', emailOrUsername, 'and password:', password);
  };
  ...
  const handleForgotPasswordClick = () => {
    ...
    console.log('Forgot Password clicked with email/username:', emailOrUsername);
  };
